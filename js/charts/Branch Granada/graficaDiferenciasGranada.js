export function graficaDiferenciasGranada(data) {
  ...
  const filters = d3.select("#filters-diferencias-Granada");
  ...
  const barriosUnicos = [...new Set(filteredGranada.map(d => d.Barrio))].sort();
  ...
  function updateChart() {
    ...
    const base = filteredGranada.filter(d =>
    ...
    svg.append("text")
      ...
      .text("Precio €/m² por barrio y características en Granada");
