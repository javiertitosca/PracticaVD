export function graficaPlantasGranada(data) {
  ...
  const filteredGranada = data.filter(d =>
    d.Ciudad === "Granada Capital"
  );
  ...
  // CHECKBOX UI
  // =========================
  const filters = d3.select("#filters-plantas-Granada");
  ...
  function updateChart() {
    ...
    svg.append("text")
      ...
      .text("Precio €/m² por barrio y planta en Granada");
