export function graficaDiferenciasMadrid(data) {
  ...
  const filters = d3.select("#filters-diferencias-Madrid");
  ...
  const barriosUnicos = [...new Set(filteredMadrid.map(d => d.Barrio))].sort();
  ...
  function updateChart() {
    ...
    svg.append("text")
      ...
      .text("Precio €/m² por barrio y características en Madrid");
