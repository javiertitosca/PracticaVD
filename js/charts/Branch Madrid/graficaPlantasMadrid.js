export function graficaPlantasMadrid(data) {
  ...
  const filteredMadrid = data.filter(d =>
    d.Ciudad === "Madrid Capital"
  );
  ...
  // CHECKBOX UI
  // =========================
  const filters = d3.select("#filters-plantas-Madrid");
  ...
  function updateChart() {
    ...
    svg.append("text")
      ...
      .text("Precio €/m² por barrio y planta en Madrid");
