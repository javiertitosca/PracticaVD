export function graficaHabitacionesMadrid(data) {
  ...
  const filters = d3.select("#filters-habitaciones-Madrid");
  ...
  function updateChart() {
    ...
    let base = filteredMadrid.filter(d =>
    ...
    svg.append("text")
      ...
      .text("Precio medio €/m² por barrio y número de habitaciones en Madrid");
