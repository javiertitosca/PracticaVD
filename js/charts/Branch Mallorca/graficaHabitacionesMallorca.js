export function graficaHabitacionesMallorca(data) {
  ...
  const filters = d3.select("#filters-habitaciones-Mallorca");
  ...
  function updateChart() {
    ...
    let base = filteredMallorca.filter(d =>
    ...
    svg.append("text")
      ...
      .text("Precio medio €/m² por barrio y número de habitaciones en Mallorca");
