export function graficaBañosBarcelona(data) {
  ...
  const filters = d3.select("#filters-baños-Barcelona");
  ...
  function updateChart() {
    ...
    svg.append("text")
      ...
      .text("Precio medio €/m² por barrio y número de baños en Barcelona");
