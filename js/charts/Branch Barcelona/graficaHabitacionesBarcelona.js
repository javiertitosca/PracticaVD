export function graficaHabitacionesBarcelona(data) {
  ...
  const filters = d3.select("#filters-habitaciones-Barcelona");
  ...
  function updateChart() {
    ...
    let base = filteredBarcelona.filter(d =>
    ...
    svg.append("text")
      ...
      .text("Precio medio €/m² por barrio y número de habitaciones en Barcelona");
