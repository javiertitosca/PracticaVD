export function graficaHabitacionesValencia(data) {
  ...
  const filters = d3.select("#filters-habitaciones-Valencia");
  ...
  function updateChart() {
    ...
    let base = filteredValencia.filter(d =>
    ...
    svg.append("text")
      ...
      .text("Precio medio €/m² por barrio y número de habitaciones en Valencia");
