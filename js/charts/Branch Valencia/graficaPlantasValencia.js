export function graficaPlantasValencia(data) {
  ...
  const filteredValencia = data.filter(d =>
    d.Ciudad === "Valencia Capital"
  );
  ...
  // CHECKBOX UI
  // =========================
  const filters = d3.select("#filters-plantas-Valencia");
  ...
  function updateChart() {
    ...
    svg.append("text")
      ...
      .text("Precio €/m² por barrio y planta en Valencia");
